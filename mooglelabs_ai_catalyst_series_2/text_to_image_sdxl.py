...
# Define VAE and diffusion pipeline for initial generation
...
# Define the prompt for initial generation
prompt = " man standing on a boat, high quality"
...
grid_image = image_grid(image.images, 1, 1)
grid_image.show()
